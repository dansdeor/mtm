 ...
 * 3. char* str type is not const and str and num are not const pointers
 * 4. num pointing type should be size_t because of strlen return value
 * 5. no check if str is not NULL and num is not NULL
 * 6. changing num value and not pointed variable value (dangerous!!!)
 ...
 * 11. in str the indexing is incorrect (supposed to be str[*num - i - 1] dangerous!!!)
 ...
 * 15. num is not conventional name
